...
复核目标 DSH 版本的 [UI Input Trigger 文档](https://github.com/deepseek-ai/deepseek-harness/blob/a66e4702047846cdaa10c66c9d3df3951f5ea70d/packages/client/ui-input-trigger/README.md)和 `SessionInput.insertReference()` 类型。若该版本的 occurrence、clipboard projection 或 CAS 参数不同，应先更新设计，不能用完整原文草稿冒充原生引用。
