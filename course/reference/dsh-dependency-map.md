...
表格对应当前 BranchMark 的 DSH `0.1.2-rc.1` 依赖图。后续源码还涉及 handle 与日志格式，不能仅按角色名称推断兼容；升级时查看[兼容性清单](compatibility-and-limitations.md)与[第 13 章](../tutorials/13-dsh-prerelease-upgrade.md)。
